 ...
 */
final class Version20221118145637 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `like` (id INT AUTO_INCREMENT NOT NULL, user_liker_id INT NOT NULL, user_liked_id INT NOT NULL, INDEX IDX_AC6340B37712F43A (user_liker_id), INDEX IDX_AC6340B3260FC79 (user_liked_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
