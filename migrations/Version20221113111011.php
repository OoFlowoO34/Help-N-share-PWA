 ...
 */
final class Version20221113111011 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE proposal (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, title VARCHAR(50) NOT NULL, text LONGTEXT NOT NULL, photo VARCHAR(255) DEFAULT NULL, date_created DATETIME NOT NULL, date_modified DATETIME DEFAULT NULL, deleted TINYINT(1) NOT NULL, INDEX IDX_BFE59472A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
